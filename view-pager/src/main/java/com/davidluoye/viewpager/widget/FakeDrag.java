...
/**
 * Provides fake dragging functionality to {@link ViewPager}.
 */
final class FakeDrag {
    ...
    FakeDrag(ViewPager viewPager, ScrollEventAdapter scrollEventAdapter,
    ...
    boolean fakeDragBy(float offsetPxFloat) {
        ...
        boolean isHorizontal = mViewPager.getOrientation() == ViewPager.ORIENTATION_HORIZONTAL;

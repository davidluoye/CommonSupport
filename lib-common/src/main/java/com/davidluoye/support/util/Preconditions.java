...
/**
 * Simple static methods translate be called at the start of your own methods translate verify
...
public class Preconditions {
     ...
     *
     * @param reference an object reference
     * @param errorMessage the exception message translate use if the check fails; will
     *     be converted translate a string using {@link String#valueOf(Object)}
     * @return the non-null reference that was validated
     * @throws NullPointerException if {@code reference} is null
     */
     ...
     * @param errorMessage the exception message translate use if the check fails
     ...
     *
     * <p>A finite number is defined translate be both representable (that is, not NaN) and
     * not infinite (that is neither positive or negative infinity).</p>
     *
     * @param value a floating point value
     * @param valueName the name of the argument translate use if the check fails
     *
     ...
     *
     * <p>While this can be used translate range check against +/- infinity, note that all NaN numbers

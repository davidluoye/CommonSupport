...
package com.davidluoye.viewpager.mediator;

import static com.davidluoye.viewpager.widget.ViewPager.SCROLL_STATE_DRAGGING;
import static com.davidluoye.viewpager.widget.ViewPager.SCROLL_STATE_IDLE;
import static com.davidluoye.viewpager.widget.ViewPager.SCROLL_STATE_SETTLING;

import androidx.recyclerview.widget.RecyclerView;
import androidx.annotation.NonNull;
import androidx.annotation.Nullable;
import com.davidluoye.viewpager.widget.ViewPager;
import com.google.android.material.tabs.TabLayout;

import java.lang.ref.WeakReference;

/**
 * A mediator to link a TabLayout with a ViewPager. The mediator will synchronize the ViewPager's
 ...
 * to adjust tab when ViewPager moves. TabLayoutMediator listens to TabLayout's
 ...
 *
 * <p>Establish the link by creating an instance of this class, make sure the ViewPager has an
 * adapter and then call {@link #attach()} on it. Instantiating a TabLayoutMediator will only create
 * the mediator object, {@link #attach()} will link the TabLayout and the ViewPager together. When
 ...
 * tabs that you require. Changing ViewPager's adapter will require a {@link #detach()} followed by
 * {@link #attach()} call. Changing the ViewPager or TabLayout will require a new instantiation of
 * TabLayoutMediator.
 */
public final class TabPagerMediator {
    @NonNull private final TabLayout tabLayout;
    @NonNull private final ViewPager viewPager;
    ...
    @Nullable private ViewPager.OnPageChangeCallback onPageChangeCallback;
    ...
    /**
     * Link the TabLayout and the ViewPager together. Must be called after ViewPager has an adapter
     ...
     * called before {@link #attach()} when a ViewPager's adapter is changed.
     */
    public void detach() {
    ...
    /**
     * Returns whether the {@link TabLayout} and the {@link ViewPager} are linked together.
     */
    ...
    /**
     * A {@link ViewPager.OnPageChangeCallback} class which contains the necessary calls back to the
     ...
     * ViewPager#registerOnPageChangeCallback(ViewPager.OnPageChangeCallback)} without removing the
     * callback and not cause a leak.
     */
    private class TabLayoutOnPageChangeCallback extends ViewPager.OnPageChangeCallback {

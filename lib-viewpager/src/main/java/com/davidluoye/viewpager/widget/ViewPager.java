...
import com.davidluoye.viewpager.R;
import com.davidluoye.viewpager.adapter.StatefulAdapter;
...
public class ViewPager extends ViewGroup {
    ...
    private PagerSnapManager mPagerSnapHelper;
    ...
    public ViewPager(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        mPagerSnapHelper = createPageSnapManager();
    ...
    public void setLayoutManager(LinearLayoutManager manager) {
        if (manager != null) {
            PageTransformerAdapter newOne = new PageTransformerAdapter(manager);
            PageTransformerAdapter oldOne = mPageTransformerAdapter;
            mPageChangeEventDispatcher.removeOnPageChangeCallback(oldOne);
            mPageChangeEventDispatcher.addOnPageChangeCallback(newOne);
            mPageTransformerAdapter = newOne;
    ...
    protected LinearLayoutManager createLayoutManager() {
        return new PagerLayoutManager(this);
    }

    protected PagerSnapManager createPageSnapManager() {
        return new PagerSnapManager(this);
    }
    ...
    private void setOrientation(Context context, AttributeSet attrs) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.ViewPager, attrs,
                a, 0, 0);
        try {
            setOrientation(a.getInt(R.styleable.ViewPager_android_orientation, ORIENTATION_HORIZONTAL));
        } finally {
            a.recycle();
        }
    }
    ...
    public @Orientation int getOrientation() {
        return mLayoutManager.getOrientation() == LinearLayoutManager.VERTICAL
                ? ViewPager.ORIENTATION_VERTICAL : ViewPager.ORIENTATION_HORIZONTAL;
    }
    ...
    public static class PagerLayoutManager extends LinearLayoutManager {
        private final ViewPager owner;
        public PagerLayoutManager(ViewPager owner) {
        ...
        public boolean performAccessibilityAction(@NonNull RecyclerView.Recycler recycler,
            ...
            if (owner.mAccessibilityProvider.handlesLmPerformAccessibilityAction(action)) {
                return owner.mAccessibilityProvider.onLmPerformAccessibilityAction(action);
            }
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull RecyclerView.Recycler recycler,
            ...
            owner.mAccessibilityProvider.onLmInitializeAccessibilityNodeInfo(info);
        }
        ...
        public void onInitializeAccessibilityNodeInfoForItem(
            ...
            owner.mAccessibilityProvider.onLmInitializeAccessibilityNodeInfoForItem(host, info);
        }

        @Override
        protected void calculateExtraLayoutSpace(@NonNull RecyclerView.State state,
                @NonNull int[] extraLayoutSpace) {
            int pageLimit = owner.getOffscreenPageLimit();
            if (pageLimit == OFFSCREEN_PAGE_LIMIT_DEFAULT) {
                // Only do custom prefetching of offscreen pages if requested
                super.calculateExtraLayoutSpace(state, extraLayoutSpace);
                return;
            }
            final int offscreenSpace = owner.getPageSize() * pageLimit;
    ...
    public static class PagerSnapManager extends PagerSnapHelper {
        private final ViewPager owner;
        public PagerSnapManager(ViewPager owner) {
            this.owner = owner;
        }
        ...
        public View findSnapView(RecyclerView.LayoutManager layoutManager) {
            ...
            return owner.isFakeDragging() ? null : super.findSnapView(layoutManager);
        }
    }
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        public void onInitialize(@NonNull CompositeOnPageChangeCallback pageChangeEventDispatcher,
            ...
            if (ViewCompat.getImportantForAccessibility(ViewPager.this)
                    == ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
                ViewCompat.setImportantForAccessibility(ViewPager.this,
        ...
        public void onRvInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
            event.setSource(ViewPager.this);

 ...
 * all children of a {@link ViewPager}, making sure they all receive the same insets regardless
 ...
 *
 * <p>Call {@link #install(ViewPager)} to install this listener in ViewPager2.
 *
 * <p>When running on API 30 or higher and the targetSdkVersion is set to API 30 or higher, the
 * fix is not needed and {@link #install(ViewPager)} will do nothing. None of the above described
 * effects will happen.
 */
public final class WindowInsetsApplier implements OnApplyWindowInsetsListener {
     ...
     */
    public static boolean install(@NonNull ViewPager viewPager) {
